...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div
            ...
            @if (request()->routeIs('admin.parceiros.*', 'admin.categorias.*', 'admin.documentos-empresa.*', 'admin.documentos-funcionario.*', 'admin.invitations.*') && auth()->check() && auth()->user()->isBackOffice())
