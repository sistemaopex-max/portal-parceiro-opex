                                ...
                                <tr>
                                    ...
                                    <td class="py-3 pe-4 text-end whitespace-nowrap">
                                        @if ($doc->arquivo_caminho)
                                            <a href="{{ route('parceiro.empresa.documentos.download', $doc) }}" class="text-indigo-600 hover:text-indigo-900 me-3">Baixar</a>
                                        @endif
                                        <form class="inline-block ms-2 align-top" method="POST" action="{{ route('parceiro.empresa.documentos.upload', $doc) }}" enctype="multipart/form-data">
                                            @csrf
